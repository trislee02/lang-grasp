...
class GraspModel(nn.Module):
    ...
    def compute_loss(self, xc, yc):
        ...
        p_loss = F.smooth_l1_loss(pos_pred, y_pos, reduction='sum')
        cos_loss = F.smooth_l1_loss(cos_pred, y_cos, reduction='sum')
        sin_loss = F.smooth_l1_loss(sin_pred, y_sin, reduction='sum')
        width_loss = F.smooth_l1_loss(width_pred, y_width, reduction='sum')
